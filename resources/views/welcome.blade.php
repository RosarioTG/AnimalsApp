        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/animal') }}" class="text-sm text-gray-700 underline">Administracion</a>
                    @else
...
<img class="h-full w-full md:w-1/3 object-cover rounded-lg " src="{{Storage::url($Animal->image)}}" >
