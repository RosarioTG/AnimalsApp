...
<head>
  ...
  <body>
  <form method= 'POST' action="{{route('specie.update',$specie->id)}}" class="form bg-white p-6 my-10 relative">
  @method('PUT')
  @csrf
      ...
      <div class="w-full flex items-center justify-between mt-0 px-6 py-2">
         ...
         <div class="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
                ...
                <div class="flex space-x-5 mt-3">
                    <input type="text" name="name" id="name" value="{{$specie -> name}} "  class="border p-2  w-1/2">
                    <input type="text" name="description" id="description" value=" {{$specie -> description}} "  class="border p-2  w-1/2">
                   </div>
