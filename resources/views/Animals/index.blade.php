    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            ...
            <div class="my-2 flex sm:flex-row flex-col">
               ...
               <a href="{{ url('Animals/create') }}" class="bg-transparent text-gray-800  p-2 rounded border border-gray-300 mr-4 hover:bg-gray-100 hover:text-gray-700">Crear Nuevo Animal</a>
            </div>
                </div>
            </div>
                    ...
                    <table class="min-w-full leading-normal">
                        ...
                        @foreach ($animals as $Animal)
                          ...
                          <button type="submit" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">
                                ...
                                <a href=""><span>
                                <div class="bg-gray-200 text-sm text-gray-500 leading-none border-2 border-gray-200 rounded-full inline-flex">
                               <a href="{{ route('Animals.edit',$Animal -> id ) }}" class="bg-transparent text-gray-800  p-2 rounded border border-gray-300 mr-4 hover:bg-gray-100 hover:text-gray-700">edit</a>
                            </li>
                           </form>
                           </td>
                            </tr>
